...
export function MissingStatementsPanel({
  status,
}: {
      ...
      <Card className="shadow-none">
        <CardHeader className="pb-2">
          <CardTitle className="text-base">
            {yearSummary.year} statement completeness
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="rounded-lg border p-3">
              ...
              <p className="text-2xl font-semibold">
                {yearSummary.waitingCount}
              </p>
            </div>
          </div>
          {yearSummary.notApplicableCount > 0 ? (
            <p className="text-muted-foreground text-sm">
              {yearSummary.completeCount} complete ·{" "}
              {yearSummary.notApplicableCount} not applicable
            </p>
          ) : null}
