...
import { filingErrorResponse } from "~/server/api/filing-http";
import { getAssessmentAttachment } from "~/server/api/filing-values";
...
export async function GET(
  ...
  try {
    ...
    const attachment = await getAssessmentAttachment(db, id);
