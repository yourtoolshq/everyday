...
export const paycheques = sqliteTable(
  "paycheques",
  {
    ...
    tenurePaycheckId: text("tenure_paycheck_id"),
    syncedFromTenure: integer("synced_from_tenure", { mode: "boolean" })
      .default(false)
      .notNull(),
    ...timestamps,
  },
  (table) => [
    ...
    uniqueIndex("paycheques_tenure_paycheck_unique").on(table.tenurePaycheckId),
    check(
