...
export async function uploadEmploymentDocument(input: UploadEmploymentDocumentInput) {
  ...
  const response = await fetch(`/api/employments/${input.employmentId}/documents`, {
    method: "POST",
    body: form,
  });
